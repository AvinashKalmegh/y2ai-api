"""
T1C AI FORMATION PERIOD SIMULATION — v3 (with Sharpe)
=======================================================
Production spec: 2023-01-01 to 2026-03-15
"""
...
CONFIG_LOCAL = {
    ...
    'INITIAL_NAV': 10_000_000, 'START_DATE': '2023-01-01', 'END_DATE': '2026-03-15',
}

def main():
    print("\nT1C AI FORMATION PERIOD — v3 (Sharpe enabled)")
    print("Production Spec: DM>=65, 5d MA rising, Exit MA20<50, DM-tiered sizing")
    print("Period: 2023-01-01 → 2026-03-15\n")

    result = run_simulation(CONFIG_LOCAL)

    print(f"\n{'='*60}")
    print("AI FORMATION PERIOD RESULTS")
    print(f"{'='*60}")
