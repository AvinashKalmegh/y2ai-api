...
This is the CONTROL. All other tests compare against this.
"""
import os, sys
...
CONFIG = {
    ...
    'ENTRY_DM': 65, 'EXIT_MA20': 50, 'HMS_MIN': 0.45,
...
if __name__ == '__main__': run("TEST 1 — BASELINE | DM 65 | HMS 0.45 | Exit MA20 < 50")
